...
This site has been developed as a static frontend site using HTML5, CSS3 and Bootstrap, following the [Code Institute Project Guidelines.](https://helensayer.github.io/the*shamans*cat/assets/images/code*institute*guidlines*ms1.pdf) This is my first milestone project to demonstrate the skills I have learnt so far on the course.
